...
![image.png](Screenshots/image31.png)
...
Πρόσβαση στον ιστότοπο του project από το PC0 το οπόιο είναι σε διαφορετικό δίκτυο από του server. Φυσικά η ιστοσελίδα δεν είναι πλήρως λειτουργική καθώς οι προσομοιωμένοι υπολογιστές του cisco packet tracer είναι πολύ απλοϊκοί και δεν περιλάμβανουν mysql.
